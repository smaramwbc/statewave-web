        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-x-6 gap-y-10 md:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5 sm:space-y-2">
              ...
              <li><Link to="/alternatives" className="text-sm text-theme-muted hover:text-theme-primary transition-colors">Alternatives</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 sm:space-y-2">
              ...
              <li><Link to="/faq" className="text-sm text-theme-muted hover:text-theme-primary transition-colors">FAQ</Link></li>
